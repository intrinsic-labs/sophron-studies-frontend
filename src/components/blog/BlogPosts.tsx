        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 md:mb-12">
          ...
          >
            ...
            <button 
              ...
              className={`flex-shrink-0 px-4 py-2 hover:bg-olive/50 ${showFilters ? 'bg-olive' : ''} text-neutral-800 transition-colors duration-300 flex items-center space-x-2 whitespace-nowrap`}
            >
              {/* <span>{'Filters'}</span> */}
